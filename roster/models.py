...
class Item(models.Model):
    ...
    age = models.IntegerField(verbose_name='年齢', validators=[validators.MinValueValidator(1)], blank=True, null=True)
    sex = models.IntegerField(verbose_name='性別', choices=SEX_CHOICES, default=1)
